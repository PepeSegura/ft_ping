...
void set_count(t_ping *ping, int pos_flag)
{
...
void set_interval(t_ping *ping, int pos_flag)
{
	int argc = ping->flags->flags[pos_flag].args_count - 1;
...
void set_ttl(t_ping *ping, int pos_flag)
{
	int argc = ping->flags->flags[pos_flag].args_count - 1;
...
void set_timeout(t_ping *ping, int pos_flag)
{
	int argc = ping->flags->flags[pos_flag].args_count - 1;
